...
.constant('SPONSORS', [{name:'Organizers',shortName:'Organizer',class:'organizer',carousel:false,columns:12,sponsors:[{name:'Warsaw Groovy User Group',url:'http://www.meetup.com/Warsaw-Groovy-User-Group/',image:'images/pl/sponsors/wgug-logo.png',image2:'images/pl/sponsors/wgug-logo.png',html:'views/pl/sponsors/_wgug.html'},{name:'SoftwareMill',url:'http://softwaremill.com/',image:'images/pl/sponsors/Softwaremill2.jpg',image2:'images/pl/sponsors/Softwaremill.jpg',html:'views/pl/sponsors/_softwaremill.html'}]}])
